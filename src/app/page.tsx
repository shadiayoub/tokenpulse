      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <div className="mb-8 relative">
            ...
            <img 
              src="/logo.png" 
              alt="TokenPulse Logo" 
              className="mx-auto max-w-[12rem] sm:max-w-[14rem] md:max-w-[16rem] lg:max-w-[18rem] relative z-10"
            />
          </div>
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-white to-[#0D1752]/5 rounded-xl shadow-lg p-8 border border-[#0D1752]/20 mb-6">
              <div className="text-center">
                <div className="inline-block p-2 bg-[#0D1752]/10 rounded-full mb-4">
                  <span className="text-[#0D1752] text-lg">💡</span>
                </div>
                <p className="text-xl text-gray-700 leading-relaxed">
                  ...
                  <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0D1752] to-[#24A354]"> multi-trillion dollar digital asset ecosystem</span>.
                </p>
              </div>
            </div>
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            <div className="inline-block p-1 bg-gradient-to-r from-[#0D1752] to-[#0D1752]/80 rounded-full mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#0D1752] bg-gradient-to-br from-white to-[#0D1752]/5">
              <div className="w-12 h-12 bg-gradient-to-br from-[#0D1752] to-[#0D1752]/80 rounded-lg flex items-center justify-center mb-6 shadow-lg">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#0D1752]/5 to-[#24A354]/5 rounded-xl shadow-lg p-8 border-l-4 border-l-[#0D1752]">
          <div className="text-center mb-8">
            <div className="inline-block p-2 bg-[#0D1752]/10 rounded-full mb-4">
              <span className="text-[#0D1752] text-lg">⚠️</span>
            </div>
        ...
        {/* For Brokers and Asset Managers Section */}
        <div className="mt-20">
          <div className="text-center mb-12">
            <div className="inline-block p-1 bg-gradient-to-r from-[#0D1752] to-[#24A354] rounded-full mb-4">
              <span className="text-white text-sm font-semibold px-4 py-1">💼 Brokers & Asset Managers</span>
            </div>
            <h2 className="text-3xl font-bold text-gray-900 mb-4">For Brokers and Asset Managers</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Streamline operations and expand your service offerings with our comprehensive tokenization platform
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#0D1752] bg-gradient-to-br from-white to-[#0D1752]/5">
              ...
              <h3 className="text-xl font-semibold text-[#0D1752] mb-4">Enhanced Service Portfolio</h3>
              <p className="text-gray-600 leading-relaxed">
                Offer your clients access to tokenized assets and expand your revenue streams with innovative financial products.
              </p>
            </Card>

            <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#24A354] bg-gradient-to-br from-white to-[#24A354]/5">
              <div className="w-12 h-12 bg-gradient-to-br from-[#24A354] to-[#24A354]/80 rounded-lg flex items-center justify-center mb-6 shadow-lg">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-[#24A354] mb-4">Operational Efficiency</h3>
              <p className="text-gray-600 leading-relaxed">
                Automate manual processes and reduce operational costs while improving client service and compliance.
              </p>
            </Card>
          </div>
        </div>

        {/* For Digital Community and Investors Section */}
        <div className="mt-20">
          <div className="text-center mb-12">
            <div className="inline-block p-1 bg-gradient-to-r from-[#0D1752] to-[#24A354] rounded-full mb-4">
              <span className="text-white text-sm font-semibold px-4 py-1">🌐 Digital Community</span>
            </div>
            <h2 className="text-3xl font-bold text-gray-900 mb-4">For Digital Community and Investors</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Access real-world yield and seamless diversification within the digital asset ecosystem
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#0D1752] bg-gradient-to-br from-white to-[#0D1752]/5">
              ...
              <h3 className="text-xl font-semibold text-[#0D1752] mb-4">Access Real-World Yield</h3>
              <p className="text-gray-600 leading-relaxed">
                Invest directly in stable, regulated assets like money market funds without ever leaving the digital ecosystem.
              </p>
            </Card>
            ...
            <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#24A354] bg-gradient-to-br from-white to-[#24A354]/5">
              ...
              <h3 className="text-xl font-semibold text-[#24A354] mb-4">Seamless Diversification</h3>
              <p className="text-gray-600 leading-relaxed">
                Instantly move capital from volatile digital assets to traditional funds—no off-ramping to fiat currency required.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-white to-[#0D1752]/5 rounded-xl shadow-lg p-8 border border-[#0D1752]/20">
          <div className="text-center mb-8">
            <div className="inline-block p-2 bg-[#0D1752]/10 rounded-full mb-4">
              <span className="text-[#0D1752] text-lg">✨</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#24A354]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-[#24A354]">💧</span>
              </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-gray-50 to-white rounded-xl shadow-lg p-8 border border-gray-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-[#24A354]">24/7</div>
              <div className="text-gray-600">Trading Available</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#0D1752]">Global</div>
              <div className="text-gray-600">Market Access</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#24A354]">Automated</div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-[#0D1752] to-[#24A354] rounded-xl shadow-xl p-8 text-white">
