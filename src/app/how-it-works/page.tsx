      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-[#24A354]"> investor management</span>
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#0D1752] bg-gradient-to-br from-white to-[#0D1752]/5">
            ...
            <h3 className="text-2xl font-semibold text-[#0D1752] mb-4">Reallocated Time and Resource</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <Card className="p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border-l-4 border-l-[#24A354] bg-gradient-to-br from-white to-[#24A354]/5">
            ...
            <h3 className="text-2xl font-semibold text-[#24A354] mb-4">ONCHAIN Custody</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
              Tokenized unit trusts and securities are centralized financial instruments using a decentralized infrastructure.
            </p>
            <div className="bg-[#24A354]/10 rounded-lg p-4">
              <p className="text-sm text-[#24A354] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#24A354]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-[#24A354]">2</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#0D1752]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-[#0D1752]">3</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#24A354]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-[#24A354]">4</span>
              </div>
